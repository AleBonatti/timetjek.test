<template>
    <div class="min-h-full">
                ...
                >
                    ...
                    <div
                        :class="[
                            ...
                            theme === 'dark'
                                ? 'bg-gray-900 ring ring-white/10 before:pointer-events-none before:absolute before:inset-0 before:bg-black/10'
                                : 'bg-white',
                        ]"
                    >
        ...
        >
            <div
                :class="[
                    'flex grow flex-col gap-y-5 overflow-y-auto border-r px-6',
                    theme === 'dark'
                        ...
                        <li class="-mx-6 mt-auto">
                            ...
                            >
                                <img
                                    ...
                                    alt=""
                                    :class="[
                                        'size-8 rounded-full outline -outline-offset-1',
                                        theme === 'dark'
                                            ? 'bg-gray-800 outline-white/10'
                                            : 'bg-gray-50 outline-black/5',
                                    ]"
                                />
                                <div
                                    v-else
        ...
        <div
            :class="[
                ...
                theme === 'dark'
                    ? 'bg-gray-900 after:pointer-events-none after:absolute after:inset-0 after:border-b after:border-white/10 after:bg-black/10'
                    : 'bg-white shadow-xs',
            ]"
        >
            <button
            ...
            <div
                :class="[
                    'flex-1 text-sm/6 font-semibold',
